...
Different techniques has been used to analyse the data and trained on different supervised and unsupervised machine learning algorithms.
...
**Part 6**: Clustering algorithms are used to identify different neuron types.
